...
class AiSubscription extends StatefulWidget {
  const AiSubscription({super.key});

  @override
  State<AiSubscription> createState() => _AiSubscriptionState();
}

class _AiSubscriptionState extends State<AiSubscription> {
        ...
        if (response.statusCode == 200) {
          ...
          if (jsonData['res'] == "success") {
            SnackBar(
                ...
                backgroundColor: const Color.fromARGB(255, 74, 201, 78));
          } else {
